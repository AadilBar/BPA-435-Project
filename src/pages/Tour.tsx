    ...
    return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', backgroundColor: '#000000', paddingTop: '20px' }}>
            ...
            <div style={styles.itemsContainer}>
                    ...
                    <EventItem imageUrl={`${import.meta.env.BASE_URL}/images/Shows/Riviera.png`} place='Riviera Theatre' address={"4746 N Racine Ave, Chicago, IL 60640"} price={500} startDate={new Date('2025-06-01')} endDate={new Date('2025-06-02')} mapData={"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3472.472809154035!2d-87.66264292357535!3d41.96865595973894!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fd22cf3dffc5b%3A0xd556d6c6fd599c1!2s4746%20N%20Racine%20Ave%2C%20Chicago%2C%20IL%2060640!5e1!3m2!1sen!2sus!4v1736049447545!5m2!1sen!2sus"}/>
                    <EventItem imageUrl={`${import.meta.env.BASE_URL}/images/Shows/SaltShed.png`} place='Salt Shed' address={"1357 N Elston Ave, Chicago, IL 60642"} price={500} startDate={new Date('2025-06-01')} endDate={new Date('2025-06-02')} mapData={"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6951.6919951081545!2d-87.66405951057561!3d41.9067366894724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fd2d83f2fb95b%3A0xce3f70174a3e2799!2s1357%20N%20Elston%20Ave%2C%20Chicago%2C%20IL%2060642!5e1!3m2!1sen!2sus!4v1736049503570!5m2!1sen!2sus"}/>
                    <EventItem imageUrl={`${import.meta.env.BASE_URL}/images/Shows/UnitedCenter.png`} place='United Center' address={"1901 W Madison St, Chicago, IL 60612"} price={500} startDate={new Date('2025-06-01')} endDate={new Date('2025-06-02')} mapData={"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3477.259710528626!2d-87.67675642357887!3d41.8807639652469!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2d3eb7f6e34d%3A0x1f0cd7161ad43000!2sUnited%20Center%2C%201901%20W%20Madison%20St%2C%20Chicago%2C%20IL%2060612!5e1!3m2!1sen!2sus!4v1736049562523!5m2!1sen!2sus"}/>
